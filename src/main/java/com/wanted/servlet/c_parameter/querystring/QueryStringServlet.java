...
public class QueryStringServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        /*
        * http://localhost:8080/querystring?name=dsad&age=2131&birthday=2026-03-10&gender=M&national=ko&hobbies=movie
        * 사용자가 요청을 보내면 요청과 관련된 모든 정보는 HttpServletRequest 객체에 담겨있다. url이 노출됌.
        * */
